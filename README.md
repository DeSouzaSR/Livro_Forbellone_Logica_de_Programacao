# Repositório para estudo do livro Lógica de Programação de Forbellone and Eberspächer

_Por Sandro Ricardo De Souza_

O objetivo deste projeto é servir como repositório para acompanhar o progresso de leitura do livro **Lógica de Programação** de André Luiz Villar Forbellone and Henri Frederico Eberspächer.
